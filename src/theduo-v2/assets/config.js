...
window.nextConfig = {
  // Required: Your Campaign Cart API key (theduo-v2 — campaign ref_id 1548)
  apiKey: 'xlmy3mkI74p1ScVKcIEWOeTjSnbooQGdY5TOxQs8',

  // Spreedly tokenization environment (per CampaignSpec v2)
