...
window.nextConfig = {
  // Campaigns API key — from CampaignSpec fresh-kitchen-prep-stack-v1 (Map ID fresh-kitchen-prep-stack-v1-db4i)
  apiKey: "d7QJDK2lzLVFn4bqYqLLC0uYDkNtddDabUtpQmVF",
  paymentEnvKey: "57862XP7AB94ZSSMYZRDHTQA7W",

  // QA/provenance breadcrumb — carried from CampaignSpec spec_identity for QA auto-discovery (not routing).
  qa: {
    spec_identity: {
      source: "campaign-map-builder",
      map_id: "fresh-kitchen-prep-stack-v1-db4i",
      id: "map:fresh-kitchen-prep-stack-v1-db4i",
      spec_url: "https://campaign-map.nextcommerce.com/api/spec/fresh-kitchen-prep-stack-v1-db4i",
      public_route_slug: "fresh-kitchen-prep-stack-v1"
    }
  },
  ...
  paymentConfig: {
    expressCheckout: {
      ...
      // Express methods per CampaignSpec available_express_payment_methods: apple_pay, google_pay.
      // PayPal dropped — not in available_payment_methods for this campaign.
  ...
  storeName: 'keer', // Required for purchase deduplication with NEXT Storefront Meta App (keer.29next.store)
  analytics: {
    enabled: true,
