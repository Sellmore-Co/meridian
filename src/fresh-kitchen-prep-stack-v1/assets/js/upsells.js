...
//
// Quantity UX helper retained for older tiered variants; Fresh uses a single visible bundle card
...
// SDK 0.4.18+ native bundle quantity can use data-next-bundle-qty-for
// This helper is harmless when no tiered quantity control is present.
