...
//
// Quantity UX: hidden per-tier bundle cards can use initBundleQtyToggle()
...
// SDK 0.4.18+ native bundle quantity (data-next-bundle-qty-for) supports
// one-card multiplier flows. Keep this helper for tier-picking fallbacks.
