...
window.nextConfig = {
  // Required: Your Campaign Cart API key (theduo-v3 — campaign ref_id 1549)
  apiKey: 'JTomGTDupL6m2Nzpz0Sp4lACt2Ooa9L1yVE3VHtO',

  // Spreedly tokenization environment (per CampaignSpec v3)
