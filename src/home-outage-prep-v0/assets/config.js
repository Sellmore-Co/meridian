...
window.nextConfig = {
  ...
  apiKey: "wDNSbdodeotU4PvSmZu3b0UBBg0PsvjaKxcqxpe5",
  ...
  paymentConfig: {
    expressCheckout: {
      ...
      methodOrder: ['apple_pay', 'google_pay'] // CampaignSpec available_express_payment_methods: apple_pay, google_pay (no paypal)
    },
    // cardInputConfig: {
    //   fieldType: {
  ...
  storeName: 'Keer', // Required for purchase deduplication with NEXT Storefront Meta App
  analytics: {
    enabled: true,
